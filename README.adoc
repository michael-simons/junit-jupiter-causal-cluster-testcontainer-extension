...
image::https://maven-badges.herokuapp.com/maven-central/eu.michael-simons.neo4j/junit-jupiter-causal-cluster-testcontainer-extension/badge.svg[link=https://maven-badges.herokuapp.com/maven-central/eu.michael-simons.neo4j/junit-jupiter-causal-cluster-testcontainer-extension]
